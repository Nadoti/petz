      ...
      <div className="w-full pt-9 pb-16">
        <div className="w-full max-w-[408px] mx-auto text-black">
          ...
          <section className="mb-4">
            <h4 className="text-base mb-4">Como funciona a cura de um pokémon?</h4>
            <p className="text-sm">
          ...
          <section className="mb-4">
            <h4 className="text-base mb-4">Uma tradição de mais de 20 anos</h4>
            <p className="text-sm">
          ...
          <section className="mb-4">
            <h4 className="text-base mb-4">O melhor para seu pokémon</h4>
            <p className="text-sm">
          ...
          <section className="">
            <h4 className="text-base mb-4">Alta Tecnologia</h4>
            <p className="text-sm">
